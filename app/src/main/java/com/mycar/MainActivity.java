...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChooseButton = findViewById(R.id.btn_choose_image);
        mUploadButton = findViewById(R.id.btn_upload);
        mProgressBar = findViewById(R.id.progress_bar);
        mImageView = findViewById(R.id.image_view);
        mNameImage = findViewById(R.id.edt_file_name);
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Upload upload = new Upload(mNameImage.getText().toString().trim(),taskSnapshot.getDownloadUrl().toString());
